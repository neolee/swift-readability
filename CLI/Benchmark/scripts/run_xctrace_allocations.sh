...
TRACE_OUT="$ROOT/CLI/Benchmark/reports/raw/allocations-${SIZE}.trace"
LOG_OUT="$ROOT/CLI/Benchmark/reports/raw/allocations-${SIZE}.log"
TARGET_BIN="$CLI_DIR/.build/release/ReadabilityCLI"
ENTITLEMENTS_FILE="$ROOT/CLI/Benchmark/scripts/allocations-debug.entitlements"
