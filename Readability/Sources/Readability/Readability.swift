...
public struct Readability {
    ...
    private func cleanAndSerialize(_ element: Element) throws -> String {
        ...
        try removeCaptionOnlyCopyrightFigures(cleaned)
    ...
    /// Remove Telegraph-style caption-only figure shells:
    /// no media descendants, but figcaption contains caption + copyrightHolder spans.
    private func removeCaptionOnlyCopyrightFigures(_ articleContent: Element) throws {
